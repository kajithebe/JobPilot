          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {resumes.map((resume) => (
              <div
                ...
                className="bg-[#0f1629] border border-gray-800 rounded-xl p-5 cursor-pointer hover:border-blue-500 transition-colors group"
              >
                <div className="flex items-start justify-between">
                  ...
                  <button
                    ...
                    className="text-gray-600 hover:text-red-400 transition-colors ml-2 opacity-0 group-hover:opacity-100 text-lg"
                  >
                    ×
                  </button>
                </div>
